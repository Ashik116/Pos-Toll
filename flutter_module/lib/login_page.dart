...
import 'package:flutter_module/card.dart';
import 'package:flutter_module/splash_screen.dart';
import 'package:flutter_module/sss.dart';
  ...
  Future signIn() async {
    ...
    if (user.text.isNotEmpty) {
      response = await https.post(
          Uri.parse("http://103.101.197.249:8080/api/login"),
          body: data);
      jsonData = json.decode(response.body);
      setState(() {
        sharedPreferences.setString("username", jsonData['data']['name']);
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          if (setCookie != null) {
            sharedPreferences.setString("headers", setCookie);
          }
        });
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: TweenAnimationBuilder(
                      ...
                      child: const Text(
                       " Orion Infrastructure Limited",// "Regnum ETC Toll",
                        style: TextStyle(
                            fontSize: 40,
                            color: Colors.white,
                            fontFamily: "Raleway"),
                                ...
                                child: MaterialButton(
                                  onPressed: () {
                                    if(user.text.isEmpty){
                                      Fluttertoast.showToast(msg: "User Name and Password is required");
                                    }else if(user.text.isEmpty){
                                      Fluttertoast.showToast(msg: "User Name and Password is required");
                                    }
                                    signIn();
                                    // Navigator.push(
                                    //     context, MaterialPageRoute(builder: (_) => CardDesign()));
                                  },
                                  height: 45,
